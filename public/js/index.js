...
var _extra = __webpack_require__(27);
...
var Main = function (_React$Component) {
	...
	function Main(props) {
		...
		_this.pushMsgQueue = _this.pushMsgQueue.bind(_this);
	...
	_createClass(Main, [{
		...
		key: "init",
		value: function init(id, openid, nickname, headimg) {
			var _this2 = this;

			this.handler = new _extra2.default.Socket({
				id: id,
				openid: openid,
				headimg: headimg,
				nickname: nickname,
		...
		value: function pushMsgQueue() {
			...
			if (this.tap) {
				var code = this.touch.next();
				this.maze.go(code);
				this.MsgFlag = true;
			}
			if (this.MsgFlag) {
				var pos = this.maze.getPos();
		...
		value: function receive(res) {
			...
			switch (_type) {
				...
				case 0:
					...
					break;
				case 200:
					this.maze = new _extra2.default.Maze(obj.maze, obj.location, obj.other, 30, 'game');
					this.touch = new _extra2.default.Touch(100, 100);
					this.pushMsgQueue();
					break;
				case 403:
					console.log(obj.msg);
		...
		value: function componentDidMount() {
			...
			this.setState({
				...
				_this4.init(id, openid, nickname, headimg);
			});
		...
		value: function render() {
			return _react2.default.createElement("div", { id: "game" });
		}
	}]);
